...
public interface IBookingRepository : IRepository<Booking>
{
    ...
    Task<(IReadOnlyList<Booking> Items, int Total)> GetHotelBookingsPagedAsync(Guid hotelId, int page, int pageSize, string? status, string? query, CancellationToken cancellationToken = default);
