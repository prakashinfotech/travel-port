...
export default function FlightOperatorBookingsPage() {
  ...
  useEffect(() => {
    flightOperatorService.getBookings()
      .then(setBookings)
    ...
    <div className="p-8">
      ...
      <div className="relative mb-4">
        ...
        <input value={search} onChange={e => setSearch(e.target.value)}
          placeholder="Search by ref, passenger name or email…"
            ...
            <tbody className="divide-y divide-gray-50">
              {filtered.map(b => (
                <tr key={b.id} className="hover:bg-gray-50 transition">
                  <td className="px-4 py-3 font-mono font-semibold text-blue-700">{b.bookingRef}</td>
