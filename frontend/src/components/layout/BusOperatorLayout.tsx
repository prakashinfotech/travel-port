...
import { LayoutDashboard, BookOpen, Bus, LogOut } from 'lucide-react'
import { useAuth } from '@/hooks/useAuth'

const navItems = [
  { to: '/bus-operator/dashboard', icon: LayoutDashboard, label: 'Dashboard' },
  { to: '/bus-operator/buses',     icon: Bus,             label: 'My Buses'  },
  { to: '/bus-operator/bookings',  icon: BookOpen,        label: 'Bookings'  },
]

export function BusOperatorLayout() {
    ...
    <div className="flex min-h-screen bg-gray-50">
      <aside className="w-64 shrink-0 bg-white border-r border-gray-200 flex flex-col">
        <div className="flex items-center gap-3 px-6 py-5 border-b border-gray-100">
          ...
          <div>
            <p className="text-sm font-bold text-gray-900 leading-tight">Bus Operator</p>
